      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            Text("🌍 Support Meaningful Causes – Easily discover verified charities and urgent campaigns.  📊 Track Your Impact – View your donation history and see how funds are used.  🔒 Secure & Transparent – Every transaction is recorded and traceable.",
                style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
            ),
            SizedBox(height: 15 ),
